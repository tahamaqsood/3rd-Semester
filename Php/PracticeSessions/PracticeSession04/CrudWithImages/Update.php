...
box-shadow: 0px 1px 12px 2px rgba(0,0,0,0.75);">
      ...
      if(isset($_POST['UpdateBtn']))
      {
          ...
          if(is_uploaded_file($_FILES['image']['tmp_name']))
          {
              if(strtolower($image_type)=="image/png" || strtolower($image_type)=="image/jpg" || strtolower($image_type)=="image/jpeg")
              {
                  if($image_size<=1000000)
                  {
                      ...
                      $query = "update USERS set FNAME='$fname', LNAME='$lname', AGE='$age', GENDER='$gender', CITY='$city', IMAGE_PATH='$folder' where ID='$id'";
          ...
          {
            $query = "update USERS set FNAME='$fname', LNAME='$lname', AGE='$age', GENDER='$gender', CITY='$city' where ID='$id'";
            $exec = mysqli_query($con,$query);
            if($exec==true)
            {
              echo "

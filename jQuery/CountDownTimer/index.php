...
<body>
    ...
    <div class="container">
        <div class="row"> <!-- 1st Row -->
            <div class="col-md-12">
                <h1 class="text-center text-uppercase jumbotron text-white bg-dark">Count Down Timer Functions In Jquery</h1>
            </div>
        </div>
        ...
        <div class="row"> <!-- 2nd Row -->
            <div class="col-md-12">
                ...
                <a href="#" class="btn btn-secondary" id="btn">Set Timer In This Page</a>
